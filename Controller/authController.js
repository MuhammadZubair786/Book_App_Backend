    ...
    try {
        ...
        if (checkuser) {
            ...
            const info = {
                ...
                <p>Welcome to Book App! Please use the OTP below to verify your account.</p>
            ...
            attachments: [
                {
                    filename: 'image.jpg',
                    path: 'https://img.freepik.com/premium-psd/open-book-with-landscape-trees-flowers-it-world-book-day-poster_354831-1618.jpg?size=626&ext=jpg&ga=GA1.1.1209391547.1676050961&semt=sph',
